...
let myName = User(name: "Ahmed", age: 21, height: 170.0, weight: 75.0, activityLevel: 9)
print(myName)
...
let otherDistance = Distance(feet: 1000)

print("Meters: \(otherDistance.meters)")
print("Feet: \(otherDistance.feet)")
