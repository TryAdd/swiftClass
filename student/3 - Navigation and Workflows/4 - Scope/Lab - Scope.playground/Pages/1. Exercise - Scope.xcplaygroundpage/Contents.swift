...
// it will show an error because foo is local
...
//x is accessable through the program as it is a global scope
...
greeting(greeting: "Welcome", name: "Fatima")
greeting(greeting: nil, name: "Ahmed")
